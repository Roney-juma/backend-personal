...
const GROUPS = {
  ...
  'Customers': [
    'VIEW_CUSTOMERS', 'CREATE_CUSTOMER', 'UPDATE_CUSTOMER', 'DELETE_CUSTOMER', 'IMPORT_CUSTOMERS',
  ],
  'Garages': [
  ...
  // The covers an insurer sells. Reads are open like claim types — reference
  // data every policy form needs — so only the mutations are gated.
  'Policy Types': [
    'VIEW_POLICY_TYPES', 'CREATE_POLICY_TYPE', 'UPDATE_POLICY_TYPE', 'DELETE_POLICY_TYPE',
  ],
  'Support': [
...
const DEFAULT_ROLES = {
  'Claims Manager': [
    ...
    'VIEW_GLASS_CLAIMS', 'APPROVE_GLASS_CLAIM', 'ASSIGN_GLASS_SUPPLIER', 'COMPLETE_GLASS_CLAIM',
    'VIEW_CUSTOMERS', 'VIEW_GARAGES', 'VIEW_ASSESSORS', 'VIEW_SUPPLIERS', 'VIEW_CLAIM_TYPES', 'VIEW_POLICY_TYPES',
  ...
  'Operations': [
    ...
    'VIEW_POLICY_TYPES', 'CREATE_POLICY_TYPE', 'UPDATE_POLICY_TYPE',
  ],
