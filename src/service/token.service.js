...
const {
  TokenIssuer,
  TokenSecret,
} = require("../constants/encryption.constants.js");
const { Encrypt } = require("../utils/encription.js");
const { readPrivateKey } = require("../config/keys.js");
...
const GenerateToken = (user) => {
  ...
  const tenantRef = [user.insuranceCompany, user.company].find(
    (v) => v && typeof v === "object"
  );
  const data = {
    id: user._id,
